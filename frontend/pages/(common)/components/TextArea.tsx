...
export const TextArea = ({ label, ...props }:MyTextInputProps) => {
    ...
    return (
      <div className='w-full flex flex-col gap-1 h-28'>
        ...
        <textarea className=" w-full bg-gray-100 border p-3 h-16 rounded-lg  placeholder:text-slate-500 placeholder:text-sm" {...field} {...props} />
