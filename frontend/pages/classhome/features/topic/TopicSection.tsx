    ...
    <div className='flex flex-col w-full'>
      <div className='flex justify-between my-8'>
        <div className='flex border-gray-300 border rounded-lg'>
          ...
          <input data-cy='ClassHomePage-TopicSection-Search-Input' type='text' className='p-2  placeholder:italic rounded-r-lg' placeholder={` Search topic`} onChange={(e) => setSearch(e.target.value)} />
        </div>            
        <Button dataCy='ClassHomePage-AddTopic-OpenModal-Button' text={`${monHeader} +`} value={openAddTopicModal} setValue={setOpenAddTopicModal} />
      </div>
