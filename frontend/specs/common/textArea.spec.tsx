...
const setup = (name: string, labelText: string) => render(
  ...
  >
    <Form>
      <TextArea label={labelText} name={name} type="text" placeholder="Enter your username" />
    </Form>
  </Formik>
);
...
describe('Input common component', () => {
  ...
  it('does not display error message when not touched', () => {
    render(
      ...
      >
        <Form>
          <TextArea label="Username" name="username" type="text" placeholder="Enter your username" />
        </Form>
      </Formik>
    );
